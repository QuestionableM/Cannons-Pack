...
if CP_ADDITIONS_SCRIPT_LOADED then return end
CP_ADDITIONS_SCRIPT_LOADED = true
...
local cannon_settings = {
	["86b45499-9a8f-45ce-b9f9-80b6912fcc06"] = { --AircraftCannon
		server_settings = {
			proj_config = {
				...
				position = _newVec(0, 0, 0.2),					velocity = _newVec(0, 0, 700),
				friction = 0.003,								gravity = 10,
				shellEffect = "AircraftCannon - Shell",			lifetime = 15,
				explosionEffect = "AircraftCannon - Explosion",	explosionLevel = 1,
				explosionRadius = 0.2,							explosionImpulseRadius = 5,
				explosionImpulseStrength = 900,					syncEffect = true
			},
			cannon_config = {
	...
	["49de462c-2f36-4ad5-802c-c4add235dc53"] = { --FlakCannon
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 0.8),			velocity = _newVec(0, 0, 400),
				friction = 0.003,						gravity = 10,
				shellEffect = "FlakCannon - Shell",		lifetime = 30,
				explosionEffect = "ExplSmall",			explosionLevel = 5,
				explosionRadius = 0.2,					explosionImpulseRadius = 10,
	...
	["bd428d5e-c519-43fe-a75f-76cfddb5b700"] = { --HowitzerCannon
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 2.2),			velocity = _newVec(0, 0, 400),
				friction = 0.003,						gravity = 100,
				shellEffect = "HowitzerCannon - Shell",	lifetime = 30,
				explosionEffect = "ExplBig2",			explosionLevel = 6000,
				explosionRadius = 3,					explosionImpulseRadius = 70,
				explosionImpulseStrength = 25000,		syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
				impulse_dir = _newVec(0, 0, -1),
	...
	["03e1ecbd-17ee-4045-a5d8-366f6e656555"] = { --M1AbramsCannon
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 1.3),			velocity = _newVec(0, 0, 400),
				friction = 0.005,						gravity = 10,
				shellEffect = "M1AbramsCannon - Shell",	lifetime = 30,
				explosionEffect = "ExplBig",			explosionLevel = 8,
				explosionRadius = 1.2,					explosionImpulseRadius = 30,
				explosionImpulseStrength = 15000,		syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
				impulse_dir = _newVec(0, 0, -1),
	...
	["6c0bbf06-364f-4d51-98c2-1631b2d09cd5"] = { --NavalCannon
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 2.1),			velocity = _newVec(0, 0, 350),
				friction = 0.005,						gravity = 25,
				shellEffect = "NavalCannon - Shell",	lifetime = 30,
				explosionEffect = "ExplBig2",			explosionLevel = 10,
				explosionRadius = 2,					explosionImpulseRadius = 60,
				explosionImpulseStrength = 17000,		syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
				impulse_dir = _newVec(0, 0, -1),
	...
	["d0352961-c071-4278-8f23-99fcb8a7a377"] = { --NavalCannon2
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 1),			velocity = _newVec(0, 0, 400),
				friction = 0.003,						gravity = 10,
				shellEffect = "NavalCannon2 - Shell",	lifetime = 30,
				explosionEffect = "ExplBig",			explosionLevel = 7,
				explosionRadius = 1.3,					explosionImpulseRadius = 50,
				explosionImpulseStrength = 15000,		syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
	...
	["35203ea3-8cc8-4ec9-9a26-c62c6eb5544d"] = { --SmartCannon
		localPosition = true,						localVelocity = false,
		position = _newVec(0, 0, 0),				velocity = _newVec(0, 0, 0),
		friction = 0.0,								gravity = 0,
		shellEffect = "NumberLogicCannon - Shell",	lifetime = 0,
		explosionLevel = 0,							explosionRadius = 0,
		explosionImpulseRadius = 0,					explosionImpulseStrength = 0,
		explosionEffect = "ExplSmall",				proxFuze = 0,
		syncEffect = true,							proj_types = {
	...
	["fd6130e4-261d-4875-a418-96fe33bb2714"] = { --SmallSmartCannon
		...
		position = _newVec(0, 0, 0),				velocity = _newVec(0, 0, 0),
		friction = 0.0,								gravity = 0,
		shellEffect = "SmallSmartCannon - Shell",	lifetime = 0,
		explosionLevel = 0,							explosionRadius = 0,
		explosionImpulseRadius = 0,					explosionImpulseStrength = 0,
		explosionEffect = "ExplSmall",				proxFuze = 0,
		syncEffect = true,							proj_types = {
	...
	["2bcd658f-6344-4e37-9fb5-ced1e2249c7b"] = { --OrbitalCannon
		...
		explosionEffect = "ExplSmall",			explosionLevel = 10,
		explosionRadius = 0.5,					explosionImpulseRadius = 10,
		explosionImpulseStrength = 50,			syncEffect = true
	},
	...
	["04c1c87f-da87-4f5e-8d70-1ca452314728"] = { --RocketLauncher
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 0.6),			velocity = _newVec(0, 0, 105),
				friction = 0.0,							gravity = 1,
				shellEffect = "RocketLauncher - Shell",	lifetime = 15,
				explosionEffect = "ExplBig",			explosionLevel = 10,
				explosionRadius = 0.7,					explosionImpulseRadius = 30,
				explosionImpulseStrength = 8000,		syncEffect = true,
				keep_effect = true
			},
			cannon_config = {
				port_uuid = nil,
	...
	["f85af057-f779-4eca-ad1c-58d2828d3404"] = { --SchwererGustavCannon
		server_settings = {
			proj_config = {
				localPosition = true,						localVelocity = false,
				position = _newVec(0, 0, 3.5),				velocity = _newVec(0, 0, 250),
				friction = 0.003,							gravity = 40,
				shellEffect = "DoraCannon - Shell",			lifetime = 30,
				explosionEffect = "DoraCannon - Explosion",	explosionLevel = 15,
				explosionRadius = 7,						explosionImpulseRadius = 180,
				explosionImpulseStrength = 25000,			syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
	...
	["bc8178a9-8a38-4c43-a0d0-8a0f242a59c7"] = { --TankCannon
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 0.4),			velocity = _newVec(0, 0, 400),
				friction = 0.003,						gravity = 10,
				shellEffect = "TankCannon - Shell",		lifetime = 30,
				explosionEffect = "ExplBig",			explosionLevel = 6,
				explosionRadius = 0.7,					explosionImpulseRadius = 12,
				explosionImpulseStrength = 6000,		syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
				impulse_dir = _newVec(0, 0, -1),
	...
	["388ccd57-1be9-40cc-b96b-69dd16eb4f32"] = { --TankCannon3
		server_settings = {
			proj_config = {
				localPosition = true,					localVelocity = false,
				position = _newVec(0, 0, 1.2),			velocity = _newVec(0, 0, 400),
				friction = 0.003,						gravity = 10,
				shellEffect = "M1AbramsCannon - Shell",	lifetime = 30,
				explosionEffect = "ExplBig",			explosionLevel = 8,
				explosionRadius = 1.2,					explosionImpulseRadius = 15,
				explosionImpulseStrength = 10000,		syncEffect = true
			},
			cannon_config = {
				port_uuid = "5164495e-b681-4647-b622-031317e6f6b4",
				impulse_dir = _newVec(0, 0, -1),
	...
	["5164495e-b681-4647-b622-031317e6f6b4"] = { --ShellEjector
		proj_config = {
			position = _newVec(0, 0.15, 0),			velocity = _newVec(0, 0, 7),
	...
	if obj_effects ~= nil then
		if type(obj_effects) == "table" then
			...
			for id, effect in pairs(obj_effects) do
				local success, eff = pcall(_createEffect, effect, self.interactable)
				if success then
					effect_set[id] = eff
				else
					_cpPrint("Couldn't load an effect. Error message: "..eff)
				end
			end
			return effect_set
		else
		...
		_cpPrint(("A set of effects for object \"%s\" doesn't exist!"):format(self.shape.uuid))
	end
end

if not _CP_gScript then
	_CP_gScript = {}
end
...
function _cp_isObjectVisible(v1, v1Pred, v2, LimiterXY, LimiterZ)
	local NormalizedObjectPos = (v1 - v1Pred):normalize()
	local NormalizedTargetPos = (v1 - v2):normalize()
	local ObjectXYAngle = _mathAtan2(NormalizedObjectPos.y, NormalizedObjectPos.x)
	local TargetXYAngle = _mathAtan2(NormalizedTargetPos.y, NormalizedTargetPos.x)
	local AngleXY = ObjectXYAngle - TargetXYAngle
	AngleXY = (AngleXY > _pi and AngleXY - _2pi) or (AngleXY < -_pi and AngleXY + _2pi) or AngleXY
	local ObjectZAngle = _mathAsin(NormalizedObjectPos.z)
	local TargetZAngle = _mathAsin(NormalizedTargetPos.z)
...
function _cp_shootProjectile(shape, projectile, offset, direction, ignoreRotation)
...
function _cpProj_betterExplosion(position, expl_level, expl_radius, expl_impulse, expl_magnitude, effect, pushPlayers)
	...
	for k, body in pairs(_getAllBodies()) do
		...
		if distance_to_shape < expl_magnitude and body:isDynamic() then
			...
			local impulse_strength = _mathMax(expl_impulse * (1 - (distance_to_shape / expl_magnitude)), 0)
			if impulse_strength > 0 then
				_applyImpulse(body, -(impulse_direction * impulse_strength), true)
			end
		end
	end
	...
	if pushPlayers then
		for k, player in pairs(_getAllPlayers()) do
			...
			if _cpExists(pl_char) then
				local result_pos = position - pl_char.worldPosition
				...
				if distance_to_player < expl_magnitude then
					...
					local impulse_str = _mathMax(expl_impulse * (1 - (distance_to_player / expl_magnitude)), 0)
					local final_impulse = (impulse_dir * impulse_str) / 10

					_applyImpulse(pl_char, -final_impulse, false)
				end
			end
		end
		...
		for k, unit in pairs(_getAllUnits()) do
			local unit_char = unit.character

			if _cpExists(unit_char) then
				local result_pos = position - unit_char.worldPosition
				local distance_to_unit = result_pos:length()

				if distance_to_unit < expl_magnitude then
					local impulse_dir = result_pos:normalize()
					local impulse_str = _mathMax(expl_impulse * (1 - (distance_to_unit / expl_magnitude)), 0)
					local final_impusle = (impulse_dir * impulse_str) / 5

					if distance_to_unit < limited_impulse_radius then
						unit_char:setTumbling(true)
						unit_char:applyTumblingImpulse(-final_impusle)
					else
						_applyImpulse(unit_char, -final_impusle, false)
					end
				end
			end
		end
...
function _cpProj_cl_onProjHit(proj_effect, keep_effect)
	...
	if _smExists(proj_effect) then
		proj_effect:setPosition(_newVec(0, 0, 10000))
		proj_effect:stop()
...
function _cpProj_cl_destroyProjectiles(proj_table)
	...
	for k, projectile in pairs(proj_table) do
		...
		if proj_effect ~= nil and _smExists(proj_effect) then
			proj_effect:setPosition(_newVec(0, 0, 10000))
			proj_effect:stop()
			proj_effect:destroy()
...
function _cpProj_getNearestVisibleFlare(flare_table, rocket_pos, rocket_p_pos)
	...
	for k, flare in pairs(flare_table) do
		local isFlareVisible = _cp_isObjectVisible(rocket_pos, rocket_p_pos, flare.pos, 1.22173, 1.22173)
